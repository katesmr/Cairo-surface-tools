...
int main(void) 
{
    ...
    unsigned char CHANNEL_VALUE = 80; /* just a random value from 0..255 */ 
    CHANNEL_OFFSET dest_channel = BLUE_CHANNEL_OFFSET; /* channel you'd like to change 0 or 1 or 2 or 3*/

    set_channel(cr_dest, img, dest_channel, CHANNEL_VALUE);
